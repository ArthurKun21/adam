...
public class SendFileSubSession(private val session: Session) {
    public suspend fun receiveFile(fixture: File): SendFileSubSession {
    ...
    public suspend fun fail(message: String) {
        ...
        session.output.respondStringV1(message)
    }
}
